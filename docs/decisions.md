...
| 5 | **First anchor is 2013, not 2012** | 2026-09-19 | Measured: `appearances` starts 2012-07-03, so a 2012-07-01 anchor has no prior-season performance data. Supersedes `min_anchor_season: 2012` in the original config. |
